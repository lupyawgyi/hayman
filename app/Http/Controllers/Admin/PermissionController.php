...
use App\Http\Requests\PermisionInsertFormRequest;
...
//        $roles = Role::query()->orderBy('id', 'asc')->where('id','1');
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(PermisionInsertFormRequest $request)
    {
...
//
    ...
    public function destroy($id)
    {
        $permission = Permission::find($id);
        $permission->Delete();
        return redirect('/backend/permissions/index')->with('status', 'Successfully Deleted Data!');
    }

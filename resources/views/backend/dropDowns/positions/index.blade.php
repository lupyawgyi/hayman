...
<div class="container-fluid">
    ...
    <div class="my-2">
        ...
        <div>
            <a href="{{url('backend/dropDowns/positions/create')}}" class="btn btn-outline-primary mt-3 text-center"><i
                    class="fa fa-xbox" aria-hidden="true"></i> &nbsp;Create New Position</a>
        </div>
        <div class="card-body">
    ...
    $(document).ready(function () {
        $("#mm").DataTable({
            ...
            "ajax": {
                ...
                url: "/backend/positions/ssd"
            },
            {{--            ajax: '{!! route('get.roles') !!}',--}}
            columns: [
                {data: 'name', name: 'name'},
                {data: 'phoneBill',name:'phoneBill'},

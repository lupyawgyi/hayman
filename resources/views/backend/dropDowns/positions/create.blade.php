    ...
    <div class="col-md-4 mt-4">
        <div class="card card-body">
            <form method="post">
                ...
                <div class="form-group">
                    <label for="branchName">Phone Bill*</label>
                    <input type="text" class="form-control " id="phoneBill" placeholder="Enter Bill Amount" name="phoneBill"
                           value="{{old('phoneBill')}}" required>
                </div>
                <div class="form-group">

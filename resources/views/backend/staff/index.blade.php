...
<div class="container-fluid">
    ...
    <div class="my-2">
        ...
        <div>
            <a href="{{url('backend/staff/create')}}" class="btn btn-outline-primary mt-3 text-center"><i
                    class="fa fa-xbox" aria-hidden="true"></i> &nbsp;Create New Staff</a>
        </div>
        <div class="card-body">
